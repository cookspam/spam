...
pub enum OreInstruction {
    #[account(0, name = "spam_program", desc = "Spam program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "bus_0", desc = "Spam bus account 0", writable)]
    #[account(3, name = "bus_1", desc = "Spam bus account 1", writable)]
    #[account(4, name = "bus_2", desc = "Spam bus account 2", writable)]
    #[account(5, name = "bus_3", desc = "Spam bus account 3", writable)]
    #[account(6, name = "bus_4", desc = "Spam bus account 4", writable)]
    #[account(7, name = "bus_5", desc = "Spam bus account 5", writable)]
    #[account(8, name = "bus_6", desc = "Spam bus account 6", writable)]
    #[account(9, name = "bus_7", desc = "Spam bus account 7", writable)]
    #[account(10, name = "mint", desc = "Spam token mint account", writable)]
    #[account(11, name = "treasury", desc = "Spam treasury account", writable)]
    #[account(12, name = "treasury_tokens", desc = "Spam treasury token account", writable)]
    #[account(13, name = "token_program", desc = "SPL token program")]
    Reset = 0,

    #[account(0, name = "spam_program", desc = "Spam program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "proof", desc = "Spam proof account", writable)]
    #[account(3, name = "system_program", desc = "Solana system program")]
    Register = 1,

    #[account(0, name = "spam_program", desc = "Spam program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "bus", desc = "Spam bus account", writable)]
    #[account(3, name = "proof", desc = "Spam proof account", writable)]
    #[account(4, name = "treasury", desc = "Spam treasury account")]
    ...
    #[account(3, name = "proof", desc = "Spam proof account", writable)]
    #[account(4, name = "treasury", desc = "Spam treasury account", writable)]
    #[account(5, name = "treasury_tokens", desc = "Spam treasury token account", writable)]
    ...
    #[account(8, name = "bus_6", desc = "Spam bus account 6", writable)]
    #[account(9, name = "bus_7", desc = "Spam bus account 7", writable)]
    #[account(10, name = "mint", desc = "Spam mint account", writable)]
    #[account(11, name = "treasury", desc = "Spam treasury account", writable)]
    #[account(12, name = "treasury_tokens", desc = "Spam treasury token account", writable)]
    ...
    #[account(0, name = "spam_program", desc = "Spam program")]
    #[account(1, name = "signer", desc = "Admin signer", signer)]
    #[account(2, name = "treasury", desc = "Spam treasury account")]
    UpdateAdmin = 101,
